    ...
    return (
        ...
        >
            ...
            >
                            ...
                            <div className='flex flex-col justify-center md:flex md:flex-row md:justify-between items-center w-full gap-2'>
                                ...
                                <div className="text-center md:text-right relative order-1 md:order-1">
                                    ...
                                    <div className="flex items-center justify-center md:justify-end gap-2">
                                        ...
                                        <div className="w-12 md:w-16 h-0.5 bg-gradient-to-l from-[#a47d52] to-[#c4a37a]"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            {!loginMode && (
                                <div className="flex-shrink-0">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <div className="absolute right-2.5 md:right-3 top-1/2 -translate-y-1/2 text-[#8a7e6f]/40 group-focus-within:text-[#a47d52] transition-colors duration-300">
                                            <svg
                            ...
                            <div className="flex-shrink-0">
                                <label className="block text-xs md:text-sm font-medium text-[#8a7e6f] mb-1 md:mb-1.5">
                                    <span className="flex items-center gap-1.5 md:gap-2">
                                        ...
                                        كلمة المرور
                                        {loginMode && (
                                            <span className="text-[8px] md:text-xs text-[#a47d52] mr-1 md:mr-2 font-normal bg-[#a47d52]/10 px-1.5 md:px-2 py-0.5 rounded-full">
                                                دخول تلقائي
                                            </span>
                                        )}
                                    </span>
                ...
                {/* ============================================ */}
                {/* RIGHT SIDE — INFORMATION PANEL (Arabic RTL) - Compact */}
                {/* ============================================ */}
                <div
                    dir="rtl"
                    className="hidden lg:flex flex-col items-center justify-center text-white px-4 xl:px-6 2xl:px-8 lg:order-2 flex-shrink-0"
                    ...
                    <div className="mt-6 xl:mt-8 2xl:mt-10 grid grid-cols-3 gap-4 xl:gap-6 2xl:gap-8 w-full max-w-sm xl:max-w-md">
                        {[
                            ...
                            <div
                                ...
                                className="
                                    bg-white/10 backdrop-blur-md rounded-xs p-6 xl:p-8 2xl:p-10
