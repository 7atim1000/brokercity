...
function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (form.password.length < 4) {
            setMsg("يجب أن تتكون كلمة المرور من 4 أحرف على الأقل");
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (!savedAccessToken || !savedRefreshToken) {
                    ...
                    setMsg(
                        "⚠️ تم تسجيل الدخول بنجاح ولكن تعذر حفظ الرموز."
                    );
            ...
            setMsg(
                "⚠️ حدث خطأ أثناء تسجيل الدخول. يرجى المحاولة مرة أخرى."
            );
    ...
    // User role configurations with enhanced colors and icons - Arabic
    const userRoles = {
        manager: {
            title: 'المدير العام',
            icon: IoShield,
    ...
    return (
            ...
            >
                ...
                ">
                    ...
                    ">
                        ...
                        <div className="absolute top-0 left-0 w-32 h-32 overflow-hidden opacity-5">
                        ...
                        <div className="absolute bottom-0 right-0 w-32 h-32 overflow-hidden opacity-5">
                            ...
                            <div className='flex flex-col justify-center md:flex md:flex-row md:justify-between items-center w-full'>
                                ...
                                <div className="text-center md:text-right relative order-1 md:order-1">
                                    ...
                                    <div className="flex items-center justify-center md:justify-end gap-2">
                                        ...
                                        <div className="w-16 h-0.5 bg-gradient-to-l from-[#a47d52] to-[#c4a37a]"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            {!loginMode && (
                                <div>
                                    ...
                                    <div className="relative group">
                                        ...
                                        <div className="absolute right-3 top-1/2 -translate-y-1/2 text-[#8a7e6f]/40 group-focus-within:text-[#a47d52] transition-colors duration-300">
                                            <svg
                                                className="w-5 h-5"
                                                fill="none"
                                                stroke="currentColor"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-[#8a7e6f] mb-1.5">
                                    <span className="flex items-center gap-2">
                                        ...
                                        كلمة المرور
                                        {loginMode && (
                                            <span className="text-xs text-[#a47d52] mr-2 font-normal bg-[#a47d52]/10 px-2 py-0.5 rounded-full">
                                                دخول تلقائي
                                            </span>
                                        )}
                                    </span>
                                ...
                                {loginMode && form.password.length === 0 && (
                                    <p className="text-xs text-[#8a7e6f]/60 mt-2 flex items-center gap-1.5">
                                        ...
                                        أدخل كلمة المرور للدخول التلقائي
                                    </p>
                                )}
                                ...
                                {loginMode && form.password.length >= 4 && (
                                    <p className="text-xs text-emerald-600 mt-2 flex items-center gap-1.5 animate-pulse">
                                        <span className="text-lg">✅</span>
                                        كلمة المرور جاهزة - الدخول التلقائي مفعل
                                    </p>
                                )}
                            </div>
        ...
        "
                ...
                {/* ============================================ */}
                {/* RIGHT SIDE — INFORMATION PANEL (Arabic RTL) */}
                {/* ============================================ */}
                <div
                    dir="rtl"
                    className="hidden lg:flex flex-col items-center justify-center text-white px-8 lg:order-2"
                ...
                >
                    <img
                        ...
                        alt="بروكر سيتي"
                        className="
                            w-48 h-auto mb-18 mr-50 drop-shadow-2xl
                            transition-transform duration-500
                            hover:scale-105
                        "
                    />

                    <h1 className="text-4xl mr-50 font-bold text-center mb-4">
                        بروكر سيتي العقارية
                    </h1>

                    <p className="text-xl mr-50 text-center text-white/90 leading-relaxed">
                        منصتك العقارية الرقمية المتكاملة
                    </p>

                    <div className="mt-10 grid grid-cols-3 gap-50 w-full max-w-md">
                        {[
                            { Icon: IoBusiness, label: "العقارات" },
                            { Icon: IoPeople, label: "العملاء" },
                            { Icon: FaTasks, label: "الإدارة" },
                        ].map(({ Icon, label }, i) => (
                            <div
                                key={label}
                                style={{
                                ...
                                className="
                                    bg-white/10 backdrop-blur-md rounded-xs p-10
            ...
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1">
                <p className="text-white/20 text-xs tracking-wider">
                    © {new Date().getFullYear()} بروكر سيتي العقارية
                </p>
